...
SuperMap iClient for JavaScript 是一套以 JavaScript 语言编写的 GIS 客户端应用开发包， 支持多种地图数据来源(百度地图、Google地图、Bing Map、天地图等)，支持多种终端，支持多种浏览器。
通过SuperMap iClient for JavaScript可快速实现浏览器上美观、流畅的地图呈现。
