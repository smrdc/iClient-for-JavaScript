...
SuperMap.Plotting.StylePanel = new SuperMap.Class({
    ...
    collectionPropertyGridRows: function(selectfeature)
    {
        ...
        var rows = [
            { "name": "标号几何ID", "value":selectfeature.geometry.symbolType, "group": "标号", "editor": "text" },
            { "name": "标号库ID", "value": selectfeature.geometry.libID, "group": "标号", "editor": "text" },
            { "name": "标号Code", "value": selectfeature.geometry.code, "group": "标号", "editor": "text" },
            { "name": "标号名字", "value": selectfeature.geometry.symbolName, "group": "标号","editor": "text" }
        ];
